...
Write-Host "========================================"
Write-Host "  Configuración Automática GCP - DICRI"
Write-Host "========================================"
...
Write-Host "⚠️  [2/8] ACCIÓN REQUERIDA:"
Write-Host "    Habilita facturación en: https://console.cloud.google.com/billing/linkedaccount?project=$PROJECT_ID"
Read-Host "    Presiona ENTER cuando hayas habilitado facturación"
...
Write-Host "🗄️  [4/8] Creando instancia Cloud SQL (esto puede tardar 5-10 minutos)..."
...
$INFO = @"
======================================
  INFORMACIÓN SENSIBLE - GUARDAR SEGURO
======================================
...
Write-Host "========================================"
Write-Host ""
Write-Host "📝 Se ha guardado toda la información en: GCP-INFO-CONFIDENCIAL.txt"
Write-Host ""
...
Write-Host ""
Write-Host "4. IMPORTANTE: Después de configurar GitHub Secrets, elimina:"
